    ...
    <div className="mb-9 bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
      ...
      <ul className="mt-4 text-gray-700 light:text-gray-300 text-lg">
        {services.map((service, index) => (
          <li key={index} className="strong mb-2">
            •{" "}
            {boldKeywords(service, [
      ...
      >
        <div className="container mx-auto">
          ...
          <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
            ...
            <div className="mx-auto fill-white bg-primary flex h-[70px] w-[70px] items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="white"
            ...
            <p className="text-center mt-4 text-gray-700 light:text-gray-300 text-xl">
          ...
          <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
            ...
            <p className="text-center mt-4 text-gray-700 light:text-gray-300 text-xl">
              The ultimate photobooth package
            </p>
            <div className="text-center font-medium">
              <p className="py-2 border-b mx-8 mt-8">
                Unlimited strips (2x6”) print or{" "}
                <span className="font-bold">postcards (4x6) </span> + GIFS +
                online gallery
              </p>
              <p className="py-2 border-b mx-8">
                Custom template + 4 template revisions
          ...
          >
            ...
            <ul className="list-disc pl-6">
              ...
              <li>
                There will be a set-up fee of $45 (not included in hourly rate)
              </li>
              <li>Non-refundable 50% deposit required</li>
              <li>
                Please book 2 weeks in advance if custom props are required
              </li>
            </ul>
          </motion.div>
        </div>
